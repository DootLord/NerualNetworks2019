% Shekel function  
function y = shekelFunctionGA(x)
% The two formal parameters (vector x (four values), and m)
% need to be specified before executing the function. 
% Assume each xi, i=1,...,4 is in [0-10] interval.
% The parameter m should be one of m = 5, 7, or 10.
% Calculates the value of Shekel for the actual parameters
